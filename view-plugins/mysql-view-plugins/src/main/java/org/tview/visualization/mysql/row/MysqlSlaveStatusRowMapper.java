...
public class MysqlSlaveStatusRowMapper implements RowMapper<MysqlSlaveStatus> {
  ...
  public MysqlSlaveStatus mapRow(ResultSet resultSet, int i) throws SQLException {
    ...
    mysqlSlaveStatus.setReplicate_Wild_Ignore_Table(resultSet.getString("Replicate_Wild_Ignore_Table"));
    ...
    mysqlSlaveStatus.setMaster_SSL_Verify_Server_Cert(resultSet.getString("Master_SSL_Verify_Server_Cert"));
    ...
    mysqlSlaveStatus.setReplicate_Ignore_Server_Ids(resultSet.getString("Replicate_Ignore_Server_Ids"));
